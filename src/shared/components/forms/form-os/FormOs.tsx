              ...
              <Grid
                ...
                <Grid item xs={4}>
                  <FormControl
                    ...
                    <Select label="Tipo de Equipamento"
          ...
          <Grid
            ...
            <S.Fieldset>
              ...
              <Grid
                ...
                spacing={1}>
                <Grid item xs={12}>
                  <TextField label="Problemas Reportados pelo Cliente"
                ...
                <Grid item xs={12}>
                  <TextField label="Problemas Encontrados pelo Técnico"
            ...
            <S.Fieldset>
              ...
              <Grid
                ...
                spacing={1}>
                <Grid item xs={12}>
                  <TextField label="Serviços Realizados"
                    {...register('services')}
                    id="services"
                    size='small'
                    multiline
